    ...
    return (
      <View style={styles.sectionContainer}>
        <View style={styles.flexRow}>
          <Text style={styles.flex1}>Barcode Content : </Text>
          <TextInput
            style={styles.flex3}
        ...
        <View style={styles.flexRow}>
          <Text style={styles.flex1}>Barcode Width : </Text>
          <TextInput
            style={styles.flex1}
          ...
          />
          <Text style={styles.flex1}>Barcode Height : </Text>
          <TextInput
            style={styles.flex1}
            keyboardType="numeric"
            maxLength={4}
        ...
        <View style={styles.flexRow}>
          <Text style={styles.flex1}>Scan Type : </Text>
          <Picker
            style={styles.flex2}
          ...
          <Text style={styles.flex1}>Barcode Margin : </Text>
          <TextInput
            style={styles.flex1}
            keyboardType="numeric"
            maxLength={2}
        ...
        <View style={styles.flexRow}>
          <Text style={styles.flex1}>Bitmap Color : </Text>
          <Picker
            style={styles.flex2}
            prompt="Color"
          ...
          <Text style={styles.flex1}>Backgroundcolor : </Text>
          <Picker
            style={styles.flex2}
    ...
    return (
      <View style={styles.sectionContainer}>
        ...
        <View style={styles.flexRow}>
          ...
          />
          <Text style={styles.flex1}>Scan Mode</Text>
          <Switch
            style={styles.flex1}
            onValueChange={() =>
          ...
          />
          <Text style={styles.flex1}>Gallery</Text>
        </View>
        <View style={styles.flexRow}>
          <Switch
            style={styles.flex1}
          ...
          />
          <Text style={styles.flex1}>Show Text</Text>
          <Switch
            style={styles.flex1}
            onValueChange={() =>
              this.setState({
          ...
          />
          <Text style={styles.flex1}>Show Text Out Bounds </Text>
          <Switch
            style={styles.flex1}
            onValueChange={() =>
          ...
          />
          <Text style={styles.flex1}>Auto Size Text </Text>
        </View>
        <View style={styles.flexRow}>
          <Text style={styles.flex1}>Color1 :</Text>
          <Picker
            style={styles.flex2}
            prompt="Color1"
          ...
          <Text style={styles.flex1}>Color2 : </Text>
          <Picker
            style={styles.flex2}
            prompt="Color2"
        ...
        <View style={styles.flexRow}>
          <Text style={styles.flex1}>Color3 : </Text>
          <Picker
            style={styles.flex2}
            prompt="Color3"
          ...
          <Text style={styles.flex1}>Color4 : </Text>
          <Picker
            style={styles.flex2}
            prompt="Color4"
        ...
        <View style={styles.flexRow}>
          <Text style={styles.flex1}>Text Color : </Text>
          <Picker
            style={styles.flex2}
            prompt="TextColor"
          ...
          <Text style={styles.flex1}>Text Background Color : </Text>
          <Picker
            style={styles.flex2}
        ...
        <View style={styles.flexRow}>
          <Text style={styles.flex1}>Text Size : </Text>
          <TextInput
            style={styles.flex1}
            keyboardType="numeric"
            maxLength={3}
          ...
          />
          <Text style={styles.flex1}>Min Text Size : </Text>
          <TextInput
            style={styles.flex1}
            keyboardType="numeric"
            maxLength={3}
          ...
          />
          <Text style={styles.flex1}>Granularity : </Text>
          <TextInput
            style={styles.flex1}
            keyboardType="numeric"
            maxLength={3}
    ...
    return (
      <SafeAreaView>
        <View
          ...
          style={styles.safeAreaView}></View>
          <View>
            <View style={styles.sectionContainer}>
